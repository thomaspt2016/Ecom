...
SECRET_KEY = 'django-insecure-6dpw9x1nz91mn+zqnh13^0*o!gkh6n&r8gfz-#3#ug7h5pzqi6'
...
INSTALLED_APPS = [
    ...
    'shop','crispy_forms','crispy_bootstrap5','loginfo','cart'
]
...
AUTH_USER_MODEL = 'loginfo.CustomUser'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processors.Incart'
            ],
        },
    },
]
